...
. scoooter/regress/install-spike.sh
...
if ! [ -d scoooter/tests/riscv-arch-test ]; then
  git clone $ARCH_TEST_REPO -b $ARCH_TEST_BRANCH scoooter/tests/riscv-arch-test
  cd scoooter/tests/riscv-arch-test; git checkout $ARCH_TEST_HASH;
